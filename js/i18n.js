...
const UI = {
  pt: {
    ...
    mapAll: "Todos", mapNews: "Notícias", mapEvents: "Eventos", mapCinema: "Cinema", showTimes: "Ver horários", news: "Notícia", event: "Evento",
    ...
    readAt: "Ler na fonte", openSource: "Abrir matéria completa", buyTicket: "Comprar ingresso", save: "Salvar", saved2: "Salvo",
  ...
  en: {
    ...
    mapAll: "All", mapNews: "News", mapEvents: "Events", mapCinema: "Movies", showTimes: "Showtimes", news: "Story", event: "Event",
    ...
    readAt: "Read at source", openSource: "Open full story", buyTicket: "Buy ticket", save: "Save", saved2: "Saved",
  ...
  es: {
    ...
    mapAll: "Todos", mapNews: "Noticias", mapEvents: "Eventos", mapCinema: "Cine", showTimes: "Ver horarios", news: "Noticia", event: "Evento",
    ...
    readAt: "Leer en la fuente", openSource: "Abrir nota completa", buyTicket: "Comprar entrada", save: "Guardar", saved2: "Guardado",
...
/* categorias */
const CATS_I18N = {
  en: { Todos: "All", Show: "Concerts", Festival: "Festivals", Esporte: "Sports", Cultura: "Culture", Cidade: "City", "Política": "Politics", Gastronomia: "Food" },
  es: { Todos: "Todos", Show: "Conciertos", Festival: "Festivales", Esporte: "Deportes", Cultura: "Cultura", Cidade: "Ciudad", "Política": "Política", Gastronomia: "Gastronomía" }
};
